        ...
        <div class="content-page">
          ...
          <div class="content">
              <div class="container">
                  ...
                  <div class="row">
                      <div class="col-sm-12">
                          <h4 class="page-title">All Package Categories</h4>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr class="text-center">
                                      <td>{{$i++}}</td>
                                      <td>{{$row->package_categoryname}}</td>
                                      <td width="400px;">{{$row->package_categorydesc}}</td>
                                      <td> 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New Package Category</h4>
        </div>
        <div class="modal-body">
          <form method="POST" action="{{ URL::to ('package_category')}}" enctype="multipart/form-data">
          {{ csrf_field() }}
            <div class="form-group col-md-12">
                <label>Category Name</label>
                <input type="text" name="package_categoryname" value="" class="form-control" placeholder="">
            </div>
            <div class="form-group col-md-12">
                <label>Category Description</label>
                <textarea class="form-control" name="package_categorydesc"></textarea>
            </div>
        </div>
