                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td width="300px;">{{$row->subdescription}}</td>
                                      <td> 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{ URL::to ('sub_category')}}" enctype="multipart/form-data">
          {{ csrf_field() }}
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" name="subcategoryname" value="" class="form-control" placeholder="">
            </div>
            <div class="form-group col-md-12">
                <label>Sub Category Description</label>
                <textarea class="form-control" name="subdescription"></textarea>
            </div>
        </div>
